...
<body>
    ...
    <main class="container-fluid content">
        ...
        <h3 style="text-align:center;">Добавить штраф</h3>
        
        <div class="contayner mt-3">
            <form action="/php/addFines.php" method="post" enctype="multipart/form-data">
              <div class="mb-3">
                ...
                <select name='user' class="form-select" aria-label="default_select" id="area-user" required>
                    <?php
                        ...
                        foreach ($arr2 as &$value2) {
                            if($value2[9] == 2){}else{
                    ?>
                    <option value="<?= $value2[0] ?>">Паспорт: <?= $value2[4] ?>, Пользователь: <?= $value2[2] ?> <?= $value2[3] ?></option>
                    <?php
                            };
                        };
                    ?>
