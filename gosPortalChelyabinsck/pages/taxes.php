...
<body>
    ...
    <main class="container-fluid content">
        <h3 style="text-align:center;">Налоги</h3>

        <?php
            if($_SESSION["role"] == 2){
        ?>

            <a href="/pages/addTaxes.php" class="btn btn-outline-dark mb-3">Добавить</a>
        ...
        <?php
            $arr = mysqli_query($mysqli, "SELECT * FROM `taxes` ORDER BY date DESC");
                ...
                <div class="card-body d-flex justify-content-between">
                    <div>
                        ...
                        ?>
                            ...
                            <p class="card-text">ИНН: <?= $value2[5] ?></p>
                        <?php
                                };
                            };
                        ?>
            ...
            ?>
                    ...
                    <div class="container card <?= $value[2] ?> p-2 mb-3">
                        <div class="card-body d-flex justify-content-between">
                            ...
                            ?>
                                <div>
                                    <a href="/php/deleteTaxes.php?id=<?= $value[0]?>" class="btn btn-outline-danger nav-btn mt-2"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </div>
